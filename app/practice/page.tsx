...
import { MockExamSkeleton } from "@/components/ui/SkeletonLoader";
...
export default function PracticePage() {
  ...
  const [generatedQuiz, setGeneratedQuiz] = useState<MockExam | null>(null);
  ...
  if (generating) {
    return <MockExamSkeleton currentStep={generationStep} />;
  }
